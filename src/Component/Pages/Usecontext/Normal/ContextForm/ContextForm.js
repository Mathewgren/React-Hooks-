...
import { useGlobalContext } from "../../../../../Hooks/Context/GlobalProvider/ContextStore";
  ...
  useEffect(() => {
    if (stateEmp.employeeId) {
      setFormData({
        ...
        phoneNumber: stateEmp.employeeId.phoneNumber,
        dob: stateEmp.employeeId.dob,
        password: stateEmp.employeeId.password,
        confirmPassword: stateEmp.employeeId.confirmPassword,
    ...
    <div>
      <div className="main-container w-75 mx-auto ">
        <div className="form-container row shadow-lg mt-5">
          ...
          <div className="text-center text-success fw-bold fs-2 mt-5 mb-5">
            Use Context
          </div>
          ...
          <div className="col-md-6">
            ...
            <input
              ...
              onChange={(event) => {
                handleFieldChange(event, phoneRegex, "phoneNumber");
              }}
          ...
          <div className="col-md-6 mb-3 mx-auto">
            <label htmlFor="confirmPassword" className="fw-bold text-dark">
              Confirm Password:
            </label>
            <input
              className={`form-control ${
              ...
              onChange={(event) => {
                handleFieldChange(event, passwordRegex, "confirmPassword");
              }}
